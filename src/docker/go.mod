...
module github.com/forestay-io/forestay-aws/src/go

go 1.27

// M0 code imports none of these yet; deps.go pins them so the build image can
// bake them before the M1 code that needs them exists. See deps.go, and
// .github/bin/resolve-deps.bash for how this file is regenerated.
